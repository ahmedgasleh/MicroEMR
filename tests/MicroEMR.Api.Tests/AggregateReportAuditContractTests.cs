...
public sealed class AggregateReportAuditContractTests
{
    ...
    public void ManifestSupportsUpgradeAndFreshProvisioningThroughUnique0046()
    {
        ...
        Assert.Equal("0047-patient-immunization-history", ids[47]);
        Assert.Equal("0048-clinical-data-migration-validation-foundation", ids[48]);
        Assert.Equal("0049-clinical-data-migration-import-foundation", ids[49]);
