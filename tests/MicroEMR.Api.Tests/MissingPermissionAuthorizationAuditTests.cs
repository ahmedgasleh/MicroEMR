...
public sealed class MissingPermissionAuthorizationAuditTests
{
    ...
    [InlineData(SecurityAuditCapabilities.EncounterEdit, PermissionKeys.EncountersEdit)]
    ...
    [InlineData(typeof(MicroEMR.Api.Controllers.PatientEncountersController), "CreateEncounterAddendum", SecurityAuditCapabilities.EncounterEdit)]
