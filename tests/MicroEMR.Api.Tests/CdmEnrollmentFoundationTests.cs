...
public sealed class CdmEnrollmentFoundationTests
{
    ...
    [Fact] public void Migration0053IsCanonicalAndExactlyOnce()
    {
        ...
        Assert.Equal("0053-cdm-enrollment-foundation",entries[53].GetProperty("migrationId").GetString());
        Assert.Equal("0054-results-provenance-correction-foundation",entries[54].GetProperty("migrationId").GetString());
