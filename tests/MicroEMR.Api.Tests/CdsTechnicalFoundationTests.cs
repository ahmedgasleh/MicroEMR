...
public sealed class CdsTechnicalFoundationTests
{
    ...
    public void Migration0052IsUniqueCanonicalAnd0053DoesNotExist()
    {
        ...
        Assert.Equal("0052-cds-foundation", entries[52].GetProperty("migrationId").GetString());
        Assert.Equal("tenant-clinical/migrations/0052-cds-foundation.sql", entries[52].GetProperty("script").GetString());
