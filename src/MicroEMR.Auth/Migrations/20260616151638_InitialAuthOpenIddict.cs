...
namespace MicroEMR.Auth.Migrations
{
    /// <inheritdoc />
    public partial class InitialAuthOpenIddict : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MenuButtonId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ButtonCode = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMenuButtons", x => x.MenuButtonId);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppMenuButtons_ButtonCode",
                table: "AppMenuButtons",
                column: "ButtonCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppModules_ModuleCode",
                table: "AppModules",
                column: "ModuleCode",
                unique: true);
